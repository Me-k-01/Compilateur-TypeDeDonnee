...
Fundefn (
Fundecl (BoolT, "even", [Vardecl (IntT, "n"); Vardecl (BoolT, "t")]),  [],
 Seq(
     Cond (
        BinOp (0, BCompar BClt, VarE (0, "n"), Const (0, IntV 0)),
        Assign (0, "n",BinOp (0, BArith BAsub, Const (0, IntV 0), VarE (0, "n"))),
        Skip),
    Seq(
        While (
            BinOp (0, BCompar BCle, VarE (0, "n"), Const (0, IntV 1)),
                Assign (0, "n",BinOp (0, BArith BAsub, VarE (0, "n"), Const (0, IntV 2)))),
